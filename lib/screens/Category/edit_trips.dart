...
class EditHoliday extends StatefulWidget {
  HomeModel triped;
  EditHoliday({super.key, required this.triped});

  @override
  State<EditHoliday> createState() => _HomeHolidayState();
}

class _HomeHolidayState extends State<EditHoliday> {
...
//     _destinatonController.text = widget.triped.destination;
//     _typeController.text = widget.triped.type;
//     _startDateController.text = widget.triped.startdate.toString();
//     _endDateController.text = widget.triped.enddate.toString();
//     _passengerController.text = widget.triped.passenger;
//     _timeController.text = widget.triped.time.toString();
//     selected = widget.triped.category == 'Business' ? 0 : 1;
//     super.initState();
